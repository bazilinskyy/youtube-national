...
if __name__ == "__main__":
    ...
    plots_class.stack_plot_country(df_countries,
                                   ...
                                   annotation_text=[0.5, 1],
                                   annotation_x_position=[0.059, 0.14],
                                   annotation_y_position=[1.031, 1.031],
                                   font_size_captions=common.get_configs("font_size") + 28,
                                   legend_x=0.92,
                                   legend_y=0.04,
    ...
    plots_class.stack_plot_country(df_countries,
                                   ...
                                   data_view="combined",
                                   title_text="Mean speed of crossing (in m/s)",
                                   annotation_text=[0.5, 1, 0.5],
                                   annotation_x_position=[0.062, 0.14, 0.58],
                                   annotation_y_position=[1.031, 1.031, 1.031],
    ...
    plots_class.stack_plot_country(df_countries,
                                   ...
                                   annotation_text=[0.5, 1, 0.5, 1],
                                   annotation_x_position=[0.062, 0.14, 0.58, 0.65],
                                   annotation_y_position=[1.031, 1.031, 1.031, 1.031],
                                   font_size_captions=common.get_configs("font_size") + 28,
                                   legend_x=0.94,
                                   legend_y=0.03,
                                   legend_spacing=0.02,
    ...
    plots_class.stack_plot_country(df_countries,
                                   ...
                                   title_text="Mean crossing initiation time (in s)",
                                   annotation_text=[1, 1],
                                   annotation_x_position=[0.071, 0.58],
                                   annotation_y_position=[1.031, 1.031],
                                   gridlines=[1, 1, 8],
    ...
    plots_class.stack_plot_country(df_countries,
                                   ...
                                   data_view="day",
                                   title_text="Mean speed of crossing (in m/s)",
                                   annotation_text=[0.2, 0.2],
                                   annotation_x_position=[0.048, 0.56],
                                   annotation_y_position=[1.031, 1.031],
    ...
    plots_class.stack_plot_country(df_countries,
                                   ...
                                   title_text="Mean crossing initiation time (in s)",
                                   annotation_text=[1, 1],
                                   annotation_x_position=[0.065, 0.576],
                                   annotation_y_position=[1.11, 1.11],
    ...
    plots_class.stack_plot_country(df_countries,
                                   ...
                                   title_text="Mean speed of crossing (in m/s)",
                                   annotation_text=[0.2, 0.2],
                                   annotation_x_position=[0.05, 0.564],
                                   annotation_y_position=[1.11, 1.11],
                                   gridlines=[0.2, 0.2, 9],
